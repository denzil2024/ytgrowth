...
export const COUNTRY_META = [
...

  {
    ...
    seoDescription: "Top YouTube channels in the UK and United Kingdom, ranked by live subscriber count. Per-niche statistics for creators in gaming, tech, finance, music. Updated daily, free.",
    intro: [
    ...
    faqs: [
      { q: "Are UK YouTube channels as profitable as US ones?",
        a: "Slightly below but in the same league. UK RPMs typically run 70-85% of US rates, depending on category. The big advantage UK channels have over the US is access to both UK and US sponsorship demand: an English-language channel with a UK audience can be sponsored by US brands targeting UK viewers, plus the entire UK brand-deal ecosystem on top." },
      { q: "What categories dominate UK YouTube?",
        a: "Football commentary and analysis (a uniquely strong UK lane), comedy and sketch, lifestyle vlogging, music, and gaming. UK has produced some of the platform's longest-running creator empires in those categories. Tech, finance, and education are smaller in the UK than in the US but still substantial." },
      { q: "How does the BBC's presence affect UK YouTube?",
        a: "BBC's YouTube presence is large (BBC News, BBC Earth, BBC channels for entertainment) but doesn't dominate the way you might expect. Independent UK creators in news, history, and culture have built audiences comparable to BBC YouTube properties. The BBC operates under content licensing and broadcast-rights rules that limit some content categories on YouTube, leaving room for independent creators." },
      { q: "Can a UK channel grow a global audience instead of just UK?",
        a: "Yes, and most large UK channels do. Channels using English with universally accessible references (rather than UK-specific in-jokes or regional accents) routinely build audiences that are 50-70% non-UK. The UK regional leaderboard captures both UK-based creators with global reach and channels with strong UK viewership regardless of where the creator lives." },
      { q: "What are the tax implications for a UK YouTuber?",
        a: "UK YouTube income is treated as self-employment for most creators. You register as self-employed with HMRC, file an annual Self Assessment, and pay income tax + Class 2/4 National Insurance on profits. Once income exceeds £85K/year you must register for VAT. Many UK creators incorporate as a limited company once income stabilises above £30-50K/year for tax-efficiency reasons." },
    ],
  },

  {
    ...
    seoDescription: "Top YouTube channels in Canada, ranked by live subscriber count. Per-niche statistics for creators in gaming, tech, finance, music, comedy. Updated daily, free.",
    intro: [
    ...
    faqs: [
      { q: "Are Canadian YouTube channels lumped in with US channels by advertisers?",
        a: "Often yes. Most US-based ad campaigns target 'North America' or 'US/Canada', which means Canadian channels with English content are bid on as part of the same audience pool. This is why Canadian RPMs run very close to US rates, despite Canada being a much smaller market by population." },
      { q: "What's the difference between English-Canadian and French-Canadian YouTube?",
        a: "Two largely separate creator economies. English-Canadian channels typically blend into the broader North American market, with audiences spread across Canada and the US. French-Canadian channels (concentrated in Quebec) operate as a distinct market with their own creator stars, audience patterns, and brand-deal economy. RPMs in French-Canadian content are typically lower than English because the addressable audience is smaller." },
      { q: "Why are Canadian outdoor and adventure channels so strong?",
        a: "Three factors: (1) Canada's outdoor culture and accessible wilderness make production logistics easy; (2) the global outdoor and gear-review audience is large and English-speaking; (3) outdoor brands (Patagonia, MEC, Backcountry, REI) actively sponsor Canadian-based outdoor channels because the content travels well to international audiences who associate Canadian wilderness with credibility." },
      { q: "How does Canadian content licensing differ from US?",
        a: "Canadian content licensing is generally similar to US for YouTube purposes. Music licensing falls under SOCAN and CMRRA in Canada (vs ASCAP/BMI in the US), which can affect how cover songs, sync licenses, and Content ID matches play out. Most Canadian creators don't notice the difference unless they're heavily music-driven." },
      { q: "Are there YouTube grants or programmes specifically for Canadian creators?",
        a: "The Canada Media Fund (CMF) has historically funded some digital-original content, and Telefilm Canada occasionally backs creator-led projects in French and English. Most YouTube creators in Canada don't tap into these because the criteria are oriented toward broadcast and feature production. Most Canadian YouTube creators self-fund via AdSense, sponsorships, and direct fan support like everywhere else." },
    ],
  },

  {
    ...
    seoDescription: "Top YouTube channels in Australia, ranked by live subscriber count. Per-niche statistics for creators in gaming, tech, finance, music, comedy. Updated daily, free.",
    intro: [
    ...
    faqs: [
      { q: "Can an Australian YouTube channel reach a global audience?",
        a: "Easily, and most established Australian channels do. English-language Australian content with universal subjects (food, fitness, tech, lifestyle) typically builds 50-80% non-Australian audiences over time. The cultural and linguistic distance to North America is small enough that content travels naturally without localisation." },
      { q: "What are Australian YouTube RPMs like compared to US and UK?",
        a: "Slightly below UK, well below US. Australian RPMs typically run 60-75% of US rates, similar to the UK. The advantage Australian creators have is that their audiences often spill into US, UK, and Canadian viewers, who all earn closer to tier-1 RPMs. A channel with 40% Australian and 60% US viewership would earn similar to a pure US channel." },
      { q: "Are Australian sports channels worth it given the smaller audience?",
        a: "Yes for cricket, AFL, NRL, and rugby. Each of these sports has substantial international diaspora audiences (UK, India, NZ, South Africa) plus strong domestic interest. The categories are also less crowded than US sports YouTube, making it easier for new creators to reach a meaningful audience size quickly." },
      { q: "What tax structures do Australian YouTubers use?",
        a: "Most start as sole traders, registering for an ABN with the ATO. Income from YouTube is reported as business income on the annual tax return. Once income passes about $75K/year many incorporate as a Pty Ltd company for tax-efficiency and liability separation. GST registration becomes mandatory at $75K turnover. Most accountants familiar with self-employment income can handle YouTube creator income easily." },
      { q: "How does YouTube's Aussie geo-restriction work?",
        a: "Most YouTube content is globally available. Specific videos can be geo-restricted by the uploader (sometimes for music licensing or rights reasons), and certain content types (live news, sports broadcasts) may be blocked in Australia due to regional rights agreements. For most independent creators, geo-restriction is not something they ever need to think about." },
    ],
  },
...
export const COUNTRY_LOOKUP_BY_CODE = Object.fromEntries(COUNTRY_META.map(c => [c.code, c]))

export function getCountry(slug) {
  return COUNTRY_LOOKUP_BY_SLUG[slug] || null
}

export const COUNTRY_SLUGS = COUNTRY_META.map(c => c.id)
