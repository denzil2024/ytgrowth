  ...
  useEffect(() => {
    ...
    style.textContent = `
      ...
      *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      .otl-faq-a { font-size: 14.5px; color: var(--ytg-text-2); line-height: 1.78; padding: 0 0 22px 0; max-width: 760px; display: none; }
...
function FaqItem({ q, a }) {
  ...
  return (
    <div className="otl-faq-item">
      <button className="otl-faq-q" onClick={() => setOpen(o => !o)} aria-expanded={open}>
