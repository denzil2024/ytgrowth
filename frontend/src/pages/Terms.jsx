  ...
  return (
    <div style={{ fontFamily: "'DM Sans', system-ui, sans-serif", background: 'var(--ytg-bg)', color: 'var(--ytg-text)', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '60px 24px 100px' }}>
        ...
        <p style={{ fontSize: 15, color: 'var(--ytg-text-2)', lineHeight: 1.8, marginBottom: 16 }}>Payments are processed by Lemon Squeezy, our authorised reseller and Merchant of Record. All prices are in USD. Subscription plans are billed monthly or annually in advance.</p>
        ...
        <p style={{ fontSize: 15, color: 'var(--ytg-text-2)', lineHeight: 1.8, marginBottom: 16 }}>All purchases are non-refundable. Because YTGrowth provides a free plan with 5 analyses before any payment is required, by the time you upgrade you have already used the product and know exactly what you are paying for. The only exception is a major technical failure on our end that makes the product completely unusable for more than 7 consecutive days. Lemon Squeezy, as our Merchant of Record, also reserves the right to issue refunds at their discretion to prevent chargebacks. Full details at <a href="/refund" style={{ color: 'var(--ytg-accent)' }}>ytgrowth.io/refund</a>.</p>
