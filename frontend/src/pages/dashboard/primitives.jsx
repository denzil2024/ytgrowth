...
export function YTGLogo({ size = 12 }) {
  // YTGrowth's own mark (favicon.png). Replaces the previous YouTube-logo
  // silhouette, which imitated a YouTube trademark (policy III.F.2a).
  return (
    <img
      src="/favicon.png"
      alt=""
      width={size}
      height={size}
      style={{ display: 'block', borderRadius: Math.max(2, size * 0.22) }}
    />
  )
}
