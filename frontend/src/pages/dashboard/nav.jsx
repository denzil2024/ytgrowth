...
export function NavSubBtn({ label, active, onClick, locked = false }) {
  return (
    <button
      onClick={onClick}
      style={{
    ...
    >
      ...
      {locked && (
        <svg
          ...
          style={{ flexShrink: 0, color: SHELL.iconIdle }}
        >
            ...
            return (
              <button
                ...
                style={{
                  ...
                  fontWeight: on ? 600 : 400, fontSize: 14, letterSpacing: '-0.01em',
