import{r as e}from"./chunk-DECur_0Z.js";import{n as t}from"./jsx-runtime-CP2iHdEU.js";var n=e(t(),1),r=`'Fraunces', Georgia, serif`,i=`'Barlow', system-ui, sans-serif`;function a(){(0,n.useEffect)(()=>{if(document.getElementById(`bp-styles`))return;let e=document.createElement(`style`);e.id=`bp-styles`,e.textContent=`
      :root {
      ...
      *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      body { background: var(--yte-bg); color: var(--yte-ink); font-family: ${i}; overflow-x: hidden; -webkit-font-smoothing: antialiased; }
      ...
      .bp-eyebrow-text { font-family: ${i}; font-size: 11px; font-weight: 600; color: var(--yte-accent); text-transform: uppercase; letter-spacing: 0.18em; }

      .bp-h1 { font-family: ${r}; font-weight: 400; letter-spacing: -0.01em; line-height: 1.06; color: var(--yte-ink); }
      .bp-h1 em { font-style: italic; color: var(--yte-accent); }
      .bp-h2 { font-family: ${r}; font-weight: 400; letter-spacing: -0.01em; line-height: 1.08; color: var(--yte-ink); }
      ...
      .bp-byline-author { font-family: ${i}; font-size: 14px; font-weight: 600; color: var(--yte-ink); letter-spacing: 0.01em; margin: 0; line-height: 1.3; }
      .bp-byline-meta { font-family: ${i}; font-size: 13px; color: var(--yte-muted); margin: 6px 0 0; line-height: 1.4; }

      /* PROSE, body typography */
      .bp-prose { max-width: 760px; margin: 0 auto; font-family: ${i}; font-size: 17.5px; line-height: 1.78; color: var(--yte-ink); }
      ...
      .bp-prose h2 { font-family: ${r}; font-size: 30px; font-weight: 400; letter-spacing: -0.3px; line-height: 1.15; color: var(--yte-ink); margin-top: 1.9em !important; margin-bottom: 0.5em !important; }
      .bp-prose h2 + p { margin-top: 0.5em !important; }
      .bp-prose h3 { font-family: ${r}; font-size: 22px; font-weight: 400; letter-spacing: -0.2px; line-height: 1.3; color: var(--yte-ink); margin-top: 1.7em !important; margin-bottom: 0.45em !important; }
      ...
      .bp-prose ol > li::before { content: counter(bp-list-counter) '.'; position: absolute; left: -1.5em; top: 0; color: var(--yte-accent); font-weight: 700; font-size: 0.95em; font-family: ${i}; }

      .bp-prose blockquote { margin: 2em 0; padding: 18px 22px; background: var(--yte-surface); border: 1px solid var(--yte-line); border-left: 3px solid var(--yte-accent); border-radius: 0; font-family: ${i}; font-size: 16px; font-style: normal; font-weight: 400; color: var(--yte-ink); line-height: 1.7; }
      ...
      .bp-prose th { padding: 13px 18px; font-family: ${i}; font-weight: 600; text-align: left; font-size: 11px; letter-spacing: 0.08em; text-transform: uppercase; color: var(--yte-muted); }
    ...
    `,document.head.appendChild(e)},[])}export{a as t};