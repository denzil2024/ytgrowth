import{r as e}from"./chunk-DECur_0Z.js";import{r as t}from"./brandHost-Bm-mHKG_.js";var n=e(t(),1),r=`'Fraunces', Georgia, serif`,i=`'Barlow', system-ui, sans-serif`;function a(){(0,n.useEffect)(()=>{if(document.getElementById(`bp-styles`))return;let e=document.createElement(`style`);e.id=`bp-styles`,e.textContent=`
      :root {
