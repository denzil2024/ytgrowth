import{r as e}from"./chunk-DECur_0Z.js";import{i as t}from"./brandHost-B1N2AmIW.js";var n=e(t(),1),r=`'Fraunces', Georgia, serif`,i=`'Barlow', system-ui, sans-serif`;function a(){(0,n.useEffect)(()=>{if(document.getElementById(`bp-styles`))return;let e=document.createElement(`style`);e.id=`bp-styles`,e.textContent=`
      :root {
