import{r as e}from"./chunk-DECur_0Z.js";import{n as t,t as n}from"./jsx-runtime-CP2iHdEU.js";import{a as r,n as i}from"./index-Dwe9k6o4.js";import"./BrandLockup-DFjMZ6Lg.js";import{t as a}from"./LandingFooter--TKFbxFt.js";import{t as o}from"./SiteHeader-DZLxzsxe.js";import{i as s,t as c}from"./posts-BdPuL8xG.js";var l=e(t(),1),u=n(),d=12;function f(){let[e,t]=(0,l.useState)(typeof window<`u`?window.innerWidth:1280);return(0,l.useEffect)(()=>{let e=()=>t(window.innerWidth);return window.addEventListener(`resize`,e),()=>window.removeEventListener(`resize`,e)},[]),{isMobile:e<=768,isTablet:e<=1024}}function p(){(0,l.useEffect)(()=>{if(document.getElementById(`bl-styles`))return;let e=document.createElement(`style`);e.id=`bl-styles`,e.textContent=`
      :root {
        --ytg-bg:           #f4f4f6;
        --ytg-bg-2:         #ecedf1;
        --ytg-bg-3:         #e6e7ec;
